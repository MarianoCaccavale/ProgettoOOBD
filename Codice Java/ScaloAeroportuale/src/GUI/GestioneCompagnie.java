	...
	public GestioneCompagnie(Controller c, Aeroporto a) {
		...
		ModificaBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (ModificaNomeCombo.getSelectedIndex() != 0) {
					...
					controllerCompagnia.Update(ModificaNomeCombo.getSelectedItem().toString(),
							(int) ModificaGrandezzaFlottaSpn.getValue(), a);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (CancellazioneNomeComboBox.getSelectedItem() != null) {
					...
					if (CancellazioneNomeComboBox.getSelectedIndex() != 0) {
						...
						ModificaNomeCombo.removeItem(CancellazioneNomeComboBox.getSelectedItem());
						CancellazioneNomeComboBox.removeItem(CancellazioneNomeComboBox.getSelectedItem());
						;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ModificaNomeCombo.addItem(NomeTf.getText().toUpperCase());
				CancellazioneNomeComboBox.addItem(NomeTf.getText().toUpperCase());
				contentPane.updateUI();
				NomeTf.setText("");
		...
		for (CompagniaAerea tmp : Compagnie) {
			...
			RicercaTextPane.setText(RicercaTextPane.getText() + "Nome compagnia: " + tmp.getNomeCompagnia()
					+ "\tGrandezza Flotta: " + tmp.getGrandezzaFlotta() + " ");
		...
		RicercaBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<CompagniaAerea> CompagnieTrovate = controllerCompagnia.ricerca(RicercaNomeTxt.getText(),
						(Integer) RicercaGrandezzaMinimaSpn.getValue(), (Integer) RicercaGrandezzaMassimaSpn.getValue(),
						a);
